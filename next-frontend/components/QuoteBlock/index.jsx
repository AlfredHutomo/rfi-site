            ...
            <div className={styles['quote-block']}>
                ...
                }
                {
                    ...
                    <div className={styles['quote-block-avatar']}>
                        <Image src={props.avatar} layout="fill" objectFit="cover" />
                    </div> :
                    <div className={styles['quote-block-avatar']}>
                ...
                {
                    (props.author != null) ?
                    <div className={styles['quote-block-author']}>{props.author}</div> : ''
                }
                {
                    (props.role != null) ?
                    <div className={styles['quote-block-role']}>{props.role}</div> : ''
                }
            </div>
        </div>
    );
