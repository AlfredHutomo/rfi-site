    ...
    return (
        <div className={styles['faq-accordion-wrapper']}>
            <div className={styles['faq-accordion-side']}>
                ...
                <path d="M190.077 21.2112C188.722 35.607 188.077 49.9741 188.077 64.4334C188.077 102.102 185.873 137.194 170.243 172.156C158.479 198.47 133.967 220.875 106.077 228.767C90.3711 233.211 73.1944 233.002 57.0767 231.211" stroke="white" stroke-width="3" stroke-linecap="round"/>
                <path d="M36.0769 220.211C38.7792 223.851 51.5157 244.992 53.0769 244.211" stroke="white" stroke-width="3" stroke-linecap="round"/>
                <path d="M58.0762 218.211C47.3644 229.22 35.5762 240.461 27.0762 253.211" stroke="white" stroke-width="3" stroke-linecap="round"/>
                </svg>
            </div>
            {
